$(document).ready(function() {
    ...
    function getWeather() { // on crée une fonction qui récupere la météo avec les instructions suivantes
      if (city == null) { // on teste si la variable city est nulle
        ...
        var myAPPID = "199474e86b5183778fb2bbfed2d8224d"; //ici on déclare notre APPID pour OpenWeatherMap
       
        $.getJSON("https://api.openweathermap.org/data/2.5/weather?q=" + city + "&appid=" + myAPPID, function(result) { // on mets le résultat dans une variable result qui vaut le code JSON qu'on voit dans le navigateur
